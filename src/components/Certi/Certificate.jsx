...
import IMG6 from '../../assets/Certificate6.jpg'
     ...
     <div className="container project_container">
      <article  className='project_item'>
           ...
           <img src={IMG1} alt="" />
             ...
             <h3>HTML, CSS & Bootstrap Certifiction with Dev Town.</h3>
      ...
      <article  className='project_item'>
           ...
           <img src={IMG3} alt="" />
             ...
             <h3>Participation Certificate in offline Mode wihh DSA Workshop.</h3>
             <div className="project_item-cta">
      ...
      <article  className='project_item'>
           <div className="project_item-image">
            <img src={IMG6} alt="" />
             ...
             <h3>Certificate of Completion of JAVA Training.</h3>
             <div className="project_item-cta">
